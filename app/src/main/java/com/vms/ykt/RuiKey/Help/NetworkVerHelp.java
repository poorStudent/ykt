package com.vms.ykt.RuiKey.Help;
...
import com.vms.ykt.RuiKey.Model.ApiRequestArgs;
...
import com.vms.ykt.RuiKey.Model.In.In_SearchOrderArgs;
import com.vms.ykt.RuiKey.Model.Out.IniInfo.Out_iniGoodsInfo;
import com.vms.ykt.RuiKey.Model.Out.IniInfo.Out_iniSoftInfo;
...
public class NetworkVerHelp {
    ...
    /*网络验证服务器地址*/
    static String ApiAddress= "http://api3.ruikeyz.com/NetVer/webapi";
...
//                           break;
//                       }
//                       ReqLogOut=ReqLogOut+1;
//                   }

                   Request request2 = new Request.Builder()
                           .url("http://api2.ruikeyz.com/NetVer/webapi")
                           .post(body)
                           .build();
