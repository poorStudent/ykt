...
import com.vms.ykt.RuiKey.Help.NetworkVerHelp;
import com.vms.ykt.RuiKey.Model.BusinessType;
import com.vms.ykt.RuiKey.Model.EncryptType;
import com.vms.ykt.RuiKey.Model.In.In_AccountLoginArgs;
import com.vms.ykt.RuiKey.Model.In.In_AccountRegisterArgs;
import com.vms.ykt.RuiKey.Model.In.In_BucklePointArgs;
import com.vms.ykt.RuiKey.Model.In.In_BuyGoodsArgs;
import com.vms.ykt.RuiKey.Model.In.In_CardLoginArgs;
import com.vms.ykt.RuiKey.Model.In.In_HeartBeatArgs;
import com.vms.ykt.RuiKey.Model.In.In_IniSoftInfoArgs;
import com.vms.ykt.RuiKey.Model.In.In_LoginOutArgs;
import com.vms.ykt.RuiKey.Model.In.In_OpenRenewAccountArgs;
import com.vms.ykt.RuiKey.Model.In.In_OpenRenewCardNumArgs;
import com.vms.ykt.RuiKey.Model.In.In_UpdOrderFlagArgs;
import com.vms.ykt.RuiKey.Model.In.In_UpdPwdArgs;
import com.vms.ykt.RuiKey.Model.In.In_accountDetailArgs;
import com.vms.ykt.RuiKey.Model.In.In_cardDetailArgs;
import com.vms.ykt.RuiKey.Model.In.In_getGoodsPriceArgs;
import com.vms.ykt.RuiKey.Model.In.In_getRemoteVarArgs;
import com.vms.ykt.RuiKey.Model.In.In_getSoftPriceListArgs;
import com.vms.ykt.RuiKey.Model.In.In_unbundMacArgs;
import com.vms.ykt.RuiKey.Model.Out.BucklePoint.Out_bucklePoint;
import com.vms.ykt.RuiKey.Model.Out.BuyGoods.Out_BuyGoods;
import com.vms.ykt.RuiKey.Model.Out.GetRemoteVar.Out_getRemoteVar;
import com.vms.ykt.RuiKey.Model.Out.GoodsPrice.Out_GoodsPrice;
import com.vms.ykt.RuiKey.Model.Out.HeartBeat.Out_heartBeat;
import com.vms.ykt.RuiKey.Model.Out.Login.Out_Login;
import com.vms.ykt.RuiKey.Model.Out.OpenRenewAccount.Out_OpenRenewAccount;
import com.vms.ykt.RuiKey.Model.Out.OpenRenewCard.Out_OpenRenewCardNum;
import com.vms.ykt.RuiKey.Model.Out.Out_DataBaseArgs;
import com.vms.ykt.RuiKey.Model.Out.SearchOrder.Out_SearchOrder;
import com.vms.ykt.RuiKey.Model.Out.SoftPriceList.Out_SoftPriceList;
import com.vms.ykt.RuiKey.Model.Out.UnbundMac.Out_unbundMacArgs;
import com.vms.ykt.RuiKey.Model.Out.accountDetail.Out_accountDetail;
import com.vms.ykt.RuiKey.Model.Out.cardDetail.Out_cardDetail;
import com.vms.ykt.RuiKey.Model.Result;
...
public class MainActivity extends AppCompatActivity {
    ...
    String cardnum = "815aab2945b9ee0d";
    String TestVer = "测试变量名";//获取软件的变量，如果变量名称为空的话，那么接口返回来的是此软件所有变量，否则就是此变量名所以应的变量值

    String heartbeatkey;//心跳Key,每次心跳此值都会变
    String token;//登录成功后的令牌
    ...
    void Demo() {
        new Thread(new Runnable() {
            @Override
            public void run() {
                maccode = NetworkVerHelp.GetMacCode(MainActivity.this.getApplicationContext());
                if (IniSoftInfo()) {
     ...
     * 心跳示例
     */
    String HeartBeat(String cardnumorusername) throws Exception {
     ...
     * 退出登录示例
     */
    String LoginOut(String cardnumorusername) throws Exception {
        String Msg = "";
        Msg = Msg + "退出登录：\n";
        //构建退出登录入参
     ...
     * 卡密登录示例
     */
    Boolean LoginByCard(String CardNum, boolean IsLoginOut) {
     ...
     * 账号登录示例
     */
    Boolean LoginAccount(String _username, String _userpwd, boolean IsLoginOut) {
        Boolean IsLoginOk = false;
        //构建账号登录入参
    ...
    //修改商品订单标记示例
    void UpdOrderFlag(String orderid, String orderflag) {
        String Msg = "";
        Boolean isUpd = true;
        if (platformtypeid != 2) {
            if (NetworkVerHelp.iniGoodsInfoData == null ||
