...
public class mooc_testAdapter extends baseRecyclerAdapter<mooc_testAdapter.ViewHolder1> {

    private moocCourseInfo mCourseIfno;
    List<WorkExamList> mWorkExamLists;
    private zjyUser mZjyUser;
    private mooc_testActivity mActivity;

    private String TAG=this.getClass().getSimpleName();
    /**
     * 事件回调监听
     */
    private mooc_testAdapter.OnItemClickListener onItemClickListener;

    private mooc_testAdapter.initRcView mInitRcView;

    public mooc_testAdapter(List<WorkExamList> data, zjyUser zjyUsers, moocCourseInfo courseIfno) {
     ...
     * @param listener
     */
    public void setOnItemClickListener(mooc_testAdapter.OnItemClickListener listener) {

        this.onItemClickListener = listener;
    }

    public void setInitView(mooc_testAdapter.initRcView listener) {
    ...
    public ViewHolder1 onCreateViewHolder(ViewGroup parent, int viewType) {
        // 实例化展示的view
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.mooc_test_recycler_item, parent, false);
        // 实例化viewholder

if (mActivity==null)
        mActivity=(mooc_testActivity) parent.getContext();
