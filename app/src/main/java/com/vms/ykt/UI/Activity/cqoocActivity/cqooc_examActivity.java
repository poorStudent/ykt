...
public class cqooc_examActivity extends AppCompatActivity {
    private static final String TAG = cqooc_examActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cqooc_exam_activity);
        initData();
        initView();
        initListener();
        Log.d(TAG, "onCreate: ");
    ...
    private void initData() {
        Intent i = getIntent();
        this.mContext = cqooc_examActivity.this;
