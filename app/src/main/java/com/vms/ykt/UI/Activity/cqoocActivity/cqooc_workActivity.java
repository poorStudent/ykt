...
public class cqooc_workActivity extends AppCompatActivity {
    private static final String TAG = cqooc_workActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cqooc_work_activity);
        initData();
        initView();
        initListener();
        Log.d(TAG, "onCreate: ");
    ...
    private void initData() {
        Intent i = getIntent();
        this.mContext = cqooc_workActivity.this;
