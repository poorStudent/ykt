...
import com.vms.ykt.UI.Fragment.newzjy.newzjy_signStu_Fragment;
...
public class newzjy_signStudentActivity extends AppCompatActivity {

    private FrameLayout mFrameLayout;
    private TabLayout mTabLayout;
    public static final String[] mTabTitle = new String[]{"未签", "已签"};
    public static final String[] FragmentTag = {"wq", "yq"};
    ...
    private void initView() {
        ...
        for (int i = 0; i < mTabTitle.length; i++) {
            View view = LayoutInflater.from(newzjy_signStudentActivity.this).inflate(R.layout.tablayout, null);
