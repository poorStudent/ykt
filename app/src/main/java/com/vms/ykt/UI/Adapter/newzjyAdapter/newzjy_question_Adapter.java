...
public class newzjy_question_Adapter extends baseRecyclerAdapter<newzjy_question_Adapter.ViewHolder1> {
    ...
    public newzjy_question_Adapter(List<SignAndQuestionStu> data) {
    ...
    @Override
    public newzjy_question_Adapter.ViewHolder1 onCreateViewHolder(ViewGroup parent, int viewType) {
        // 实例化展示的view
    ...
    @Override
    public void onBindViewHolder(final newzjy_question_Adapter.ViewHolder1 holder, int position) {
        // 绑定数据
