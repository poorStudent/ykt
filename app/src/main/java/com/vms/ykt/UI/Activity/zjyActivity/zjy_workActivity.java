...
public class zjy_workActivity extends AppCompatActivity {
    private static final String TAG = zjy_workActivity.class.getSimpleName();
    ...
    private zjy_workAdapter mRecyclerAdapter = null;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private ProgressBar mProgressBar;
    List<HomeworkInfo> mHomeworkInfoList=new ArrayList<>();
    ...
    private void loadData() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                mHomeworkInfoList = zjyMain.getAllHomeWork(mZjyUser,mCourseIfno);
