package com.vms.ykt.yktDao.newZjy;
...
public class newZjyUserDao {
   public static newZjyUser sNewZjyUser;
   public static ClassRoom sClassRoom;
   public static classActivity sClassActivity;
