...
public class ViewModelUtils {
    ...
    public static <T extends ViewModel> T getPublicViewModel(Application application, Class<T> viewModelClass, SavedStateRegistryOwner owner){
       return new ViewModelProvider((ViewModelStoreOwner) application,new SavedStateViewModelFactory(application,owner)).get(viewModelClass);
    }
    public static <T extends ViewModel> T getPublicViewModel(Activity activity, Class<T> viewModelClass,SavedStateRegistryOwner owner){
        return getPublicViewModel(activity.getApplication(),viewModelClass,owner);
    }
    public static <T extends ViewModel> T getPublicViewModel(Fragment fragment, Class<T> viewModelClass,SavedStateRegistryOwner owner){
        return getPublicViewModel(fragment.getActivity(),viewModelClass,owner);
    }
}