package com.example.networkverification;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (HasPermissions(this.getPackageName(), Manifest.permission.READ_PHONE_STATE, this.getApplicationContext()) == false||
                HasPermissions(this.getPackageName(), Manifest.permission.READ_EXTERNAL_STORAGE, this.getApplicationContext()) == false||
                HasPermissions(this.getPackageName(), Manifest.permission.WRITE_EXTERNAL_STORAGE, this.getApplicationContext()) == false) {
     ...
     * @return
     */
    public static boolean HasPermissions(String packageName, String permissionName, Context context) {
